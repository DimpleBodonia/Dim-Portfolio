<footer class="footer">
    ...
    <span class="logo-text">Dimple <span class="logo-accent">Portfolio</span></span>
</a>
                <p class="footer-description">A passionate developer building modern web experiences with clean code and creative design.</p>
            </div>
            ...
            <div class="footer-contact">
                ...
                <ul>
                    <li>
                        ...
                        <a href="mailto:kbbersalona@gmail.com">kbbersalona@gmail.com</a>
                    </li>
                    <li>
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
                        <span>Zone 1, Bangued Abra</span>
                    </li>
                </ul>
            </div>
